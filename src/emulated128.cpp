...
std::uint64_t boost::charconv::detail::umul(std::uint64_t a, std::uint64_t b) noexcept
{
...
boost::charconv::detail::value128 boost::charconv::detail::full_multiplication(std::uint64_t v1, std::uint64_t v2) noexcept
{
