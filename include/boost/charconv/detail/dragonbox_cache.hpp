...
#ifndef BOOST_CHARCONV_DETAIL_DRAGONBOX_CACHE_HPP
#define BOOST_CHARCONV_DETAIL_DRAGONBOX_CACHE_HPP
...
{
    using cache_entry_type = value128;
...
constexpr int compressed_cache_detail::compression_ratio;
constexpr std::size_t compressed_cache_detail::compressed_table_size;

#endif

}}} // Namespaces

#endif // BOOST_CHARCONV_DETAIL_DRAGONBOX_CACHE_HPP
