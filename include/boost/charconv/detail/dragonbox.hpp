...
#ifndef BOOST_CHARCONV_DETAIL_DRAGONBOX
...
namespace boost { namespace charconv {
    ...
    struct default_float_traits 
    {
        ...
        using format = typename std::conditional<detail::physical_bits<T> == 32, ieee754_binary32, ieee754_binary64>::type;
        ...
        using carrier_uint = typename std::conditional<detail::physical_bits<T> == 32, std::uint32_t, std::uint64_t>::type;
    ...
    namespace detail {
        ...
        namespace log {
            ...
            constexpr int compute(int e) noexcept {
                BOOST_CHARCONV_ASSERT(std::int32_t(e_min) <= e && e <= std::int32_t(e_max));
    ...
    namespace detail {
        ...
        struct impl : private FloatTraits, private FloatTraits::format {
            ...
            static compute_mul_parity_result compute_mul_parity(carrier_uint two_f,
                                                                ...
                                                                int beta) noexcept {
                BOOST_CHARCONV_ASSERT(beta >= 1);
                BOOST_CHARCONV_ASSERT(beta < 64);
...
#undef BOOST_CHARCONV_SAFEBUFFERS
#undef BOOST_CHARCONV_HAS_BUILTIN

#endif // BOOST_CHARCONV_DETAIL_DRAGONBOX
